package com.baizhi.imgded.phash.algorithm;


import com.baizhi.imgded.phash.data.CImage;
import com.baizhi.imgded.phash.data.Digest;
import com.baizhi.imgded.phash.data.Features;
import com.baizhi.imgded.phash.data.Projections;


/**
 * @create by: linyuan
 * @description: 对两个图片进行比较，得分越接近1图片越相似
